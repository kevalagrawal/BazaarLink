        ...
        <div className="lg:col-span-1">
          <div className="card">
            ...
            <div className="space-y-3">
              <Link to="/supplier/add-product" className="block">
                <Button variant="primary" className="w-full">Add New Product</Button>
              </Link>
              <Link to="/supplier/orders" className="block">
                <Button variant="secondary" className="w-full">Manage Orders</Button>
              </Link>
